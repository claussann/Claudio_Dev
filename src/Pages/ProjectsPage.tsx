        ...
        <div id="projectsPage" className="container">
            ...
            <div className="projects row mt-3 border border-light d-flex justify-content-center" style={{ borderRadius: "10px" }} >
                <div className='col-10 text-center p-3'>
                    ...
                    <a href="https://music-portfolio-project.netlify.app/" target="_blank" rel="noopener noreferrer"><div id="music" style={{ height: "200px" }} className="border border-light col-12 mt-2 mb-2 mx-auto"></div></a>
                </div>
            </div>
            <div className="projects row mt-3 border border-light d-flex justify-content-center" style={{ borderRadius: "10px" }} >
                <div className='col-10 text-center p-3'>
                    <p>eCommerce_Project_Demo</p>
                    <a href="https://e-portfolio-commerce.netlify.app/" target="_blank" rel="noopener noreferrer"><div id="eCommerce" style={{ height: "200px" }} className="border border-light col-12 mt-2 mb-2 mx-auto"></div></a>
                </div>
            </div>
            <div className="projects row mt-3 border border-light d-flex justify-content-center" style={{ borderRadius: "10px" }} >
                <div className='col-10 text-center p-3'>
                    <p>Fishing_inventory_Video</p>
                    <div id="fishing_inventory" onClick={openFishingModal} style={{ height: "200px" }} className="border border-light col-12 mt-2 mb-2 mx-auto"></div>
                </div>
            </div>
