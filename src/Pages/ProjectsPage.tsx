        ...
        <div className="container">
            ...
            <div className="row mt-3 border border-light d-flex justify-content-center" style={{ borderRadius: "10px" }} >
                <div className='col-10'>
                    <a href="https://music-portfolio-project.netlify.app/" target="_blank" rel="noopener noreferrer"><button id="music" style={{ height: "200px" }} className="btn btn-outline-light col-12 mt-2 mb-2 mx-auto">Music_Project</button></a>
                </div>
            </div>
            <div className="row mt-3 border border-light d-flex justify-content-center" style={{ borderRadius: "10px" }} >
                <div className='col-10'>
